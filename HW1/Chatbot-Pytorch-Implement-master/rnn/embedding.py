...
class Embedding:
    ...
    def __init__(self, embedding_path,
                 words=None, oov_as_unk=True, lower=True, rand_seed=524):#rand_seed=524
        self.word_dict = {}
        self.vectors = None
        self.lower = lower
    ...
    def _load_embedding(self, embedding_path, words):
        ...
        with open(embedding_path, encoding='utf8') as fp:  # open()需要encoding = 'utf8'才能正常
            ...
            for i, line in enumerate(fp): #使用迴圏抓取文字檔內容,依空白作為分隔,取出資料

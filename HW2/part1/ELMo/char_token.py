...
class ConvTokenEmbedder(nn.Module):
    def __init__(self, word_emb_layer, char_emb_layer, use_cuda):#, config
        ...
        self.output_dim = 512 #config['encoder']['projection_dim']
        self.emb_dim = 0
        ...
        if char_emb_layer is not None:
            ...
            filters = [[1, 32], [2, 32], [3, 64], [4, 128], [5, 256], [6, 512], [7, 1024]]#cnn_config['filters']
            char_embed_dim = 50 #cnn_config['char_dim']
            ...
            self.n_highway = 2 #cnn_config['n_highway']

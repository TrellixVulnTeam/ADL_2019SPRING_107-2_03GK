...
class Generator(nn.Module):
    ...
    def __init__(self, latent_dim, class_dim):
        ...
        self.gen = nn.Sequential(
            ...
            nn.ConvTranspose2d(in_channels=4096,
                               out_channels=2048,
                               kernel_size=4,
                               stride=2,
                               padding=1,
...
class Discriminator(nn.Module):
    ...
    def __init__(self, hair_classes, eye_classes, face_classes, glasses_classes):
        ...
        self.hair_classifier = nn.Sequential(
            ...
            nn.BatchNorm1d(256),
            nn.LeakyReLU(0.2),
            nn.Linear(256, self.hair_classes),
            nn.Softmax()
        )
        self.eye_classifier = nn.Sequential(
            ...
            nn.BatchNorm1d(256),
            nn.LeakyReLU(0.2),
            nn.Linear(256, self.eye_classes),
            nn.Softmax()
        )
        self.face_classifier = nn.Sequential(
            ...
            nn.BatchNorm1d(256),
            nn.LeakyReLU(0.2),
            nn.Linear(256, self.face_classes),
            nn.Softmax()
        )
        ...
        self.glasses_classifier = nn.Sequential(
            ...
            nn.BatchNorm1d(256),
            nn.LeakyReLU(0.2),
            nn.Linear(256, self.glasses_classes),
            nn.Softmax()
        )

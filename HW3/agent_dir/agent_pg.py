...
class AgentPG(Agent):
    def __init__(self, env, args):
        ...
        self.num_episodes = 10000 # total training episodes (actually too large...)100000
    ...
    def train(self):
        ...
        epoch_list = [] #number of time steps
        for epoch in range(self.num_episodes):
            ...
            while(not done):
                ...
                # print("!!!!!!!!!!!!action", action)
                # print("!!!!!!!!!!!!action", torch.argmax(action, 0)[0].item())
                # print("!!!!!!!!!!!!action",action.argmax())
                #print("!!!!!!!!!!!!action",action.max(0)[0].cpu())
                # action =  torch.max(action, 0)[0].item()
            ...
            average_rewardlist.append(avg_reward)
